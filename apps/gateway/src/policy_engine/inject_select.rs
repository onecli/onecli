...
use crate::db::{InjectSelection, PolicyIdentityRow, PolicyRuleV2Row, PolicyV2Rules, PrincipalSet};
use crate::ee::granular_access;
...
mod tests {
    ...
    fn a_workspace_pick_outside_the_org_boundary_denies_everything() {
        ...
        assert!(crate::ee::granular_access::denies_everything(
