...
use crate::gateway::hooks::{BodyStream, RequestMeta};
use crate::telemetry_core::BudgetCharge;
...
impl MeteringStream {
    fn fire(&mut self) {
        ...
        crate::telemetry::on_request(ctx.meta.into_event(Some(charge)));
    }
}
