...
pub fn extract_credentials(headers: &mut hyper::HeaderMap) -> Option<AwsCredentials> {
...
pub fn parse_service_region<'a>(hostname: &'a str, default_region: &'a str) -> (&'a str, &'a str) {
