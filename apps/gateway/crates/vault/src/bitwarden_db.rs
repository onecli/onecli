...
pub struct BitwardenIdentityProvider {
...
/// DB-backed connection store, scoped to a single `workspace_id` with `provider = "bitwarden"`.
///
...
pub struct BitwardenConnectionStore {
    pool: PgPool,
    workspace_id: String,
