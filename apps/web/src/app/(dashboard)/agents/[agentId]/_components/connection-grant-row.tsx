...
export const ConnectionGrantRow = ({
  ...
  // Org-fully-blocked detection for unattached rows only: the org-only ceiling
  // over the provider-level view (React Query dedupes rows of one provider).
  ...
  const manageable = hasCatalog && (attached || orgGranted);
    ...
    <div className="flex items-center justify-between gap-4 py-3">
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        <Switch
          ...
          disabled={busy || orgGranted || orgBlocked}
