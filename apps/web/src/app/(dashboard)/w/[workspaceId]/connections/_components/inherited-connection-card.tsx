...
/**
 * An org-scoped connection surfaced (read-only) on the workspace page. The
 * connection itself is managed at the org level, but workspace agents can be
 * granted access to it — so the agent-access line/dialog are shown (workspace
 * scope only).
 */
export const InheritedConnectionCard = ({
  ...
  const showAgentAccess = pageScope === "workspace";
