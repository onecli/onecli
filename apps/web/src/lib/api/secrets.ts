...
// requireWorkspace: false), workspace pages /v1/secrets. Kept SEPARATE from `list`
...
// secrets, which is exactly what a policy target may reference.
const secretsPath = (scope: PageScope) =>
  scope === "organization" ? "/v1/org/secrets" : "/v1/secrets";

export const listScoped = (scope: PageScope = "workspace") =>
