...
// The apps available to the current workspace (policy-engine step 7), backing the
// connect-picker filter. Only WORKSPACE pages are governed — availability is a
// per-workspace provisioning gate, so the org (global) connect surface is never
