...
/**
 * Cloud arm of the groups-page guards: proves the entitled-self-host fix
 * regressed nothing on cloud, where CAPS.rbac is true at build time and the
 * entitlement is forced on. Same surface as the onprem arm — only the pin
 * differs.
 */
